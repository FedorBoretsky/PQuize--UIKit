...
enum Piece: String {
    ...
    var description: String {
        switch self {
        case .pawn: return "Фигура слабенькая, но за шесть простых шагов можно стать королевой."
        case .king: return "Хотя фигура малоподвижная, она очень влиятельная. Коллеги ее защищают."
